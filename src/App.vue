<template>
  <div id="app">
    <div class="privacy-policy">
      <h1>MedDocs Privacy Policy</h1>
      <p class="last-updated">Last Updated: May 24, 2023</p>
      
      <section>
        <h2>Introduction</h2>
        <p>Welcome to MedDocs. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and use our services, and tell you about your privacy rights and how the law protects you.</p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li><strong>Medical Data</strong> includes medical history, prescriptions, diagnoses, and other health-related information you provide.</li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>To provide medical documentation services.</li>
